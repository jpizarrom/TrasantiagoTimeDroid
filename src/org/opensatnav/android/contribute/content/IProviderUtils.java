 ...
 */
public interface IProviderUtils {

  /**
   * Authority (first part of URI) for the MyTracks content provider:
   */
  public static final String AUTHORITY = "org.opensatnav.android.contribute";
  ...
  /**
   * A factory which can produce instances of {@link IProviderUtils},
  ...
  public static class Factory {
    ...
    /**
     * Creates and returns an instance of {@link IProviderUtils} which
     * uses the given context to access its data.
     */
    public static IProviderUtils get(Context context) {
    ...
    /**
     * Creates an instance of {@link IProviderUtils}.
     */
    protected IProviderUtils newForContext(Context context) {
      return new ProviderUtils(context);
    }
  }
}
